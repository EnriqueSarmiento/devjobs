    ...
    <div class="flex  flex-wrap justify-center">
        <div class="md:w-1/2 order-2 md:order-1 " >
            <div class="w-full max-w-sm">
                <div class="flex flex-col break-word bg-white border border-2 shadow-md mt-20">
                    ...
                    <form method="POST" action="{{ route('register') }}" class="py-10 px-5" novalidate>
                        ...
                        <div class="flex flex-wrap mb-6">
                            ...
                            <input id="name" type="text" class="p-3 bg-gray-100 rounded form-input w-full @error('name') border-red-500 border @enderror" name="name" value="{{ old('name') }}"  autocomplete="name" autofocus>
                        ...
                        <div class="flex flex-wrap mb-6">
                            ...
                            <input id="email" type="email" class="p-3 bg-gray-100 rounded form-input w-full @error('email') border-red-500 border @enderror" name="email" value="{{ old('email') }}"  autocomplete="email">
                        ...
                        <div class="flex flex-wrap mb-6">
                            ...
                            <input id="password" type="password" class="p-3 bg-gray-100 rounded form-input w-full @error('password') border-red-500 border @enderror" name="password"  autocomplete="new-password">
        ...
        <div class="md:w-1/2 order-1 md:order-2 text-center flex flex-col justify-center px-10">
