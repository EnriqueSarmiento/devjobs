            ...
            <div class="flex flex-col break-word bg-white border border-2 shadow-md mt-20">
                ...
                <form method="POST" action="{{ route('login') }}" class="py-10 px-5" novalidate>
                    ...
                    <div class="flex flex-wrap mb-6">
                        ...
                        <input id="email" type="email" class="p-3 bg-gray-100 rounded form-input w-full @error('email') border-red-500 border @enderror" name="email" value="{{ old('email') }}"  autocomplete="email" autofocus>
                    ...
                    <div class="flex flex-wrap mb-6">
                        ...
                        <input id="password" type="password" class="p-3 bg-gray-100 rounded form-input w-full @error('password') border-red-500 border @enderror" name="password"  autocomplete="current-password">
