                ...
                <div class="bg-gray-300 text-gray-700 uppercase text-center py-3 px-6 mb-0">
                    ...
                    <form method="POST" action="{{ route('password.email') }}" class="py-10 px-5" novalidate>
                        ...
                        <div class="flex flex-wrap mb-6">
                            ...
                            <input id="email" type="email" class="p-3 bg-gray-100 rounded form-input w-full @error('email') border-red-500 border @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus>
